        ...
        if credits:
            for actor in credits:
                if actor.get("role") == "ACTOR":
                    ...
                    character_name = actor.get("character_name") if actor.get("character_name") else ""
                    if name:
        ...
        if self.gui_mode == 1:
            ...
            if technical_name == "amazon":
                ...
                if self["JustWatchProviderModeList"].getCurrent()[0][3] == "w":
                    ...
                    if not do[1]:
                        ...
                        self.session.open(MessageBox, windowTitle="JustWatch Amazon", text=text, type=MessageBox.TYPE_INFO)
                    self['BackgroundProviderModeList'].hide()
                    self['JustWatchProviderModeList'].hide()
                    ...
                    self.amazon.dream(details, "movie")
                    return
            ...
            if technical_name == "disney":
                ...
                if self["JustWatchProviderModeList"].getCurrent()[0][5] == "w":
                    ...
                    self.disney.disneyDream(title_id, "MOVIE")
                    return
    ...
    def cbReceivedWatchlistMode(self, callback):
        ...
        if technical_name == "amazon":
            ...
            if AMAZONDREAM:
                ...
                movie_id = ""
                if data_id:
                    movie_id = data_id[self.content_stream_index][5]
                data.append(("Amazon", technical_name, movie_id, "o"))
