...
class JustWatchVRunningText(Renderer):
    def __init__(self, text):
        Renderer.__init__(self)
        self.type = NONE
        self.txfont = gFont("Regular", 16)
        self.soffset = (0, 0)
        self.txtflags = 0
        self.txtext = ""
        self.text = text
        ...
        if self.skinAttributes:
            ...
            for (attrib, value) in self.skinAttributes:
                if attrib == "font":
                    ...
                    self.txtflags |= {"top": RT_VALIGN_TOP, "center": RT_VALIGN_CENTER, "bottom": RT_VALIGN_BOTTOM}[
                        value]
                elif attrib == "halign" and value in ("left", "center", "right", "block"):
                    self.halign = {"left": eLabel.alignLeft, "center": eLabel.alignCenter, "right": eLabel.alignRight,
                                   "block": eLabel.alignBlock}[value]
                    self.txtflags |= {"left": RT_HALIGN_LEFT, "center": RT_HALIGN_CENTER, "right": RT_HALIGN_RIGHT,
